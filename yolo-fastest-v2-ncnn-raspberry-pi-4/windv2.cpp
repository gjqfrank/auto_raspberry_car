...
const int DUTY_LEFT_STR = 300000;
...
void car_backward(){
    gpio_write(pi, LF_FWD, 0); gpio_write(pi, LF_BWD, 1);
    gpio_write(pi, LB_FWD, 0); gpio_write(pi, LB_BWD, 1);
    gpio_write(pi, RF_FWD, 0); gpio_write(pi, RF_BWD, 1);
    gpio_write(pi, RB_FWD, 0); gpio_write(pi, RB_BWD, 1);
    hardware_PWM(pi, LF_PWM, PWM_FREQ, DUTY_STRAIGHT);
    hardware_PWM(pi, LB_PWM, PWM_FREQ, DUTY_STRAIGHT);
    hardware_PWM(pi, RF_PWM, PWM_FREQ, DUTY_STRAIGHT);
    hardware_PWM(pi, RB_PWM, PWM_FREQ, DUTY_STRAIGHT);
